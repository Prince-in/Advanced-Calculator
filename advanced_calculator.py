					...
					if i in d:
						...
						if opbrac.is_empty()== False:
							...
							while op in precdence:
								if (precdence[i] < precdence[op]) or (op == "/"):
									opbrac.pop()
									if operand.is_empty() == True:
										return "Error"
									a = operand.peek()
...
# ans = calculator.evaluate_expression("2/2/2")
# tokens = calculator.tokenize("99 *80  +64 -35-5  +36   -45  + 86 + ((16/   ( 35/(54 )*((    (57*(8/ (40   /5 -47/  40/ ( ( 89 +36/100))))))))))")
# print(tokens)
# history = calculator.get_history()
# print(history)
# print(b)
# print(ans)
# print((((40   /5 -47/  40/ ( ( 89 +36/100))))))